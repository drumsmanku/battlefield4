        ...
        <div className='h-[80%] flex flex-col justify-start w-full'>
          ...
          <div className='flex w-full'>
            <div className='flex w-[40%] flex-col'>
              <div style={{borderBottom:'1px solid rgba(255, 255, 255, 0.15)', borderTop:'1px solid rgba(255, 255, 255, 0.15)'}} className='w-full flex justify-between p-2 font-medium text-white'>WEAPONS
                <span className='font-bold text-sm w-[50%] text-end'> 134/195<Progress progress={60}/> </span>
              </div>
