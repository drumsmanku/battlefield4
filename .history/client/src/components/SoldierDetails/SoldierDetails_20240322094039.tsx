            ...
            <div className='flex w-full justify-between'>
              ...
              <div className='flex w-[55%] flex-col'>
                ...
                <div className=' w-full h-full grid-cols-4 flex flex-wrap'>
                  <div style={{backgroundColor:''}} className='divContainer p-2 w-[45%] mr-2 mb-2'>
                    <p  className=' grayText text-xs font-medium'>TOP VEHICLE</p>
                    <img  src={tank} alt="" width={150} />
                    <p  className=' whiteText text-xs font-bold'>{data[0]?.tank_name}</p>
                    <p  className=' grayText text-xs font-bold'>{data[0]?.tank_kills} KILLS</p>
                  </div>
                  <div style={{backgroundColor:'rgba(16, 16, 16, 0.5)'}} className='divContainer p-2 w-[45%] mb-2'>
                  ...
                  <div style={{backgroundColor:'rgba(16, 16, 16, 0.5)'}} className='divContainer p-2 mr-2 w-[45%]'>
                  ...
                  <div style={{backgroundColor:'rgba(16, 16, 16, 0.5)'}} className='divContainer p-2 w-[45%]'>
