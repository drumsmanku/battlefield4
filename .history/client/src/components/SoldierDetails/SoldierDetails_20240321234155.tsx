          ...
          <div className='h-[80%] flex flex-col justify-start w-full'>
            ...
            <div className='flex w-full justify-between'>
              <div className='flex w-[40%] flex-col'>
                <div style={{borderTop:'1px solid rgba(255, 255, 255, 0.15)'}} className='stats w-full flex justify-between p-2 font-medium text-white'>WEAPONS
                  <span className='font-bold text-sm w-[30%] text-end'> {data[0]?.weapons_min}/{data[0]?.weapons_max}<Progress progress={60}/> </span>
                </div>
                <div style={{ borderTop:'1px solid rgba(255, 255, 255, 0.15)'}} className='stats w-full flex justify-between p-2 font-medium text-white'>KITS
                  <span className='font-bold text-sm w-[30%] text-end'> {data[0]?.kits_min}/{data[0]?.kits_max}<Progress progress={60}/> </span>
                </div>
                <div style={{ borderTop:'1px solid rgba(255, 255, 255, 0.15)'}} className='stats w-full flex justify-between p-2 font-medium text-white'>VEHICLES
                  <span className='font-bold text-sm w-[30%] text-end'> {data[0]?.vehicles_min}/{data[0]?.vehicles_max}<Progress progress={60}/> </span>
                </div>
                <div style={{ borderTop:'1px solid rgba(255, 255, 255, 0.15)'}} className='stats w-full flex justify-between p-2 font-medium text-white'>MEDALS
                  <span className='font-bold text-sm w-[30%] text-end'> {data[0]?.medals_min}/{data[0]?.vehicles_max}<Progress progress={60}/> </span>
                </div>
                <div style={{ borderTop:'1px solid rgba(255, 255, 255, 0.15)'}} className=' stats w-full flex justify-between p-2 font-medium text-white'>ASSIGNMENT
                  <span className='font-bold text-sm w-[30%] text-end'> {data[0]?.assignment_min}/{data[0]?.assignment_max}<Progress progress={60}/> </span>
                </div>
                <div style={{ borderTop:'1px solid rgba(255, 255, 255, 0.15)'}} className='stats w-full flex justify-between p-2 font-medium text-white'>DOG TAGS
                  <span className='font-bold text-sm w-[30%] text-end'> {data[0]?.tags_min}/{data[0]?.tags_max}<Progress progress={60}/> </span>
                </div>
                <div style={{borderBottom:'1px solid rgba(255, 255, 255, 0.15)', borderTop:'1px solid rgba(255, 255, 255, 0.15)'}} className='stats w-full flex justify-between p-2 font-medium text-white'>BATTLEPACKS
              ...
              <div className='flex w-[55%] flex-col'>
                ...
                <div className=' w-full h-full grid-cols-4 flex flex-wrap'>
                  <div style={{backgroundColor:'rgba(16, 16, 16, 0.5)'}} className='p-2 w-[45%] mr-2 mb-2'>
                    <p style={{color:'rgba(255, 255, 255, 0.75)'}} className=' text-xs font-medium'>TOP VEHICLE</p>
                    <img src={tank} alt="" width={150} />
                    <p style={{color:'white'}} className=' text-xs font-bold'>{data[0]?.tank_name}</p>
                    <p style={{color:'rgba(255, 255, 255, 0.75)'}} className=' text-xs font-bold'>{data[0]?.tank_kills} KILLS</p>
                  </div>
                  <div style={{backgroundColor:'rgba(16, 16, 16, 0.5)'}} className='p-2 w-[45%] mb-2'>
                    <p style={{color:'rgba(255, 255, 255, 0.75)'}} className=' text-xs font-medium'>TOP PRIMARY</p>
                    <img src={ar} alt="" width={150} />
                    <p style={{color:'white'}} className=' text-xs font-bold'>{data[0]?.ar_name}</p>
                    <p style={{color:'rgba(255, 255, 255, 0.75)'}} className=' text-xs font-bold'>{data[0]?.ar_kills} KILLS</p>
                  </div>
                  <div style={{backgroundColor:'rgba(16, 16, 16, 0.5)'}} className='p-2 mr-2 w-[45%]'>
                    <p style={{color:'rgba(255, 255, 255, 0.75)'}} className=' text-xs font-medium'>TOP CLASS</p>
                    <div className='w-full flex justify-center'>
                     <img src={vec} alt="" width={60} />
                    </div>
                    
                    <p style={{color:'white'}} className=' text-xs font-bold'>{data[0]?.util_name}</p>
                    <p style={{color:'rgba(255, 255, 255, 0.75)'}} className=' text-xs font-bold'>{data[0]?.util_score} SCORE</p>
                  </div>
                  <div style={{backgroundColor:'rgba(16, 16, 16, 0.5)'}} className='p-2 w-[45%]'>
                    <p style={{color:'rgba(255, 255, 255, 0.75)'}} className=' text-xs font-medium'>TOP SIDEARM</p>
                    <div className='w-full flex justify-center'>
                      <img src={pistol} alt="" width={100} />
                    </div>
                   
                    <p style={{color:'white'}} className=' text-xs font-bold'>{data[0]?.pistol_name}</p>
                    <p style={{color:'rgba(255, 255, 255, 0.75)'}} className=' text-xs font-bold'>{data[0]?.pistol_kills} KILLS</p>
                  </div>
                </div>
              </div>
            </div>
