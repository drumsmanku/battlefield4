...
export default function SoldierDetails() {
  ...
  return (
    <div className=' w-[70%] h-full flex flex-col items-center '>
      <div style={{borderBottom:'1px solid rgba(255, 255, 255, 0.15)'}} className=' w-full  flex space-x-6 h-[10%] items-end font-medium text-slate-300'>
        ...
        <div className='h-[80%] flex flex-col justify-start w-full'>
          ...
          {/* <div className='flex w-full'>
            <div className='flex w-[40%] flex-col'>
              <div style={{borderBottom:'1px solid rgba(255, 255, 255, 0.15)', borderTop:'1px solid rgba(255, 255, 255, 0.15)'}} className='w-full flex justify-between p-2 font-medium text-white'>WEAPONS</div>
            </div>
