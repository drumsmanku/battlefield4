        ...
        <div className='h-[80%] flex flex-col justify-start w-full'>
          ...
          <div className='flex w-full justify-between'>
            ...
            <div className='flex w-[55%] flex-col'>
              ...
              <div className=' w-[100%] h-full grid-cols-4 flex flex-wrap'>
                <div style={{backgroundColor:'rgba(16, 16, 16, 0.5)'}} className='p-2 w-[40%] mr-2 mb-2'>
                ...
                <div style={{backgroundColor:'rgba(16, 16, 16, 0.5)'}} className='p-2 w-[40%] mb-2'>
                  <p style={{color:'rgba(255, 255, 255, 0.75)'}} className=' text-xs font-medium'>TOP VEHICLE</p>
                  <img src={ar} alt="" width={150} />
                  <p style={{color:'white'}} className=' text-xs font-bold'>MAIN BATTLE TANK</p>
                  <p style={{color:'rgba(255, 255, 255, 0.75)'}} className=' text-xs font-bold'>33 KILLS</p>
                </div>
                <div style={{backgroundColor:'rgba(16, 16, 16, 0.5)'}} className='p-2 mr-2 w-[40%]'>
                  <p style={{color:'rgba(255, 255, 255, 0.75)'}} className=' text-xs font-medium'>TOP VEHICLE</p>
                  <img src={vec} alt="" width={150} />
                  <p style={{color:'white'}} className=' text-xs font-bold'>MAIN BATTLE TANK</p>
                  <p style={{color:'rgba(255, 255, 255, 0.75)'}} className=' text-xs font-bold'>33 KILLS</p>
                </div>
                <div style={{backgroundColor:'rgba(16, 16, 16, 0.5)'}} className='p-2 w-[40%]'>
                  <p style={{color:'rgba(255, 255, 255, 0.75)'}} className=' text-xs font-medium'>TOP VEHICLE</p>
                  <img src={pistol} alt="" width={150} />
                  <p style={{color:'white'}} className=' text-xs font-bold'>MAIN BATTLE TANK</p>
                  <p style={{color:'rgba(255, 255, 255, 0.75)'}} className=' text-xs font-bold'>33 KILLS</p>
                </div>
              </div>
