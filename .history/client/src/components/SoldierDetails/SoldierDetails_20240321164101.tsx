...
export default function SoldierDetails() {
  ...
  useEffect(()=>{
    axios.get('http://localhost:4000/get-soldier')
          .then(res=>{setData(data); console.log(res)})
            ...
            <div className='flex w-[55%] flex-col'>
              ...
              <div className=' w-full h-full grid-cols-4 flex flex-wrap'>
                ...
                <div style={{backgroundColor:'rgba(16, 16, 16, 0.5)'}} className='p-2 w-[45%] mb-2'>
                  ...
                  <p style={{color:'white'}} className=' text-xs font-bold'>ACW-R</p>
                  <p style={{color:'rgba(255, 255, 255, 0.75)'}} className=' text-xs font-bold'>495 KILLS</p>
                </div>
                <div style={{backgroundColor:'rgba(16, 16, 16, 0.5)'}} className='p-2 mr-2 w-[45%]'>
                  ...
                  <p style={{color:'white'}} className=' text-xs font-bold'>ENGINEER</p>
                  <p style={{color:'rgba(255, 255, 255, 0.75)'}} className=' text-xs font-bold'>828.514 SCORE</p>
                </div>
                <div style={{backgroundColor:'rgba(16, 16, 16, 0.5)'}} className='p-2 w-[45%]'>
                  ...
                  <p style={{color:'white'}} className=' text-xs font-bold'>M9</p>
                  <p style={{color:'rgba(255, 255, 255, 0.75)'}} className=' text-xs font-bold'>112 KILLS</p>
                </div>
              </div>
            </div>
          </div>
