...
import './SideMenu.css'; // Import CSS file for styles
    ...
    <div style={{borderRight:'1px solid rgba(255, 255, 255, 0.15)'}} className=' w-[4.5%] h-full flex flex-col  justify-between'>
      <div className=' space-y-4 h-[65%] flex flex-col justify-end'>
        <div className='w-full space-y-4 '>
          <img className='ml-4 opacity-50 hover:opacity-100' src={game_side_2} alt="games" width={35} />
          <img className=' ml-4 opacity-50 hover:opacity-100' src={game_side_1} alt="games" width={35} />
          <img  src={game_side_3} className='opacity-50 hover:opacity-100' alt="games" width={55} />
          <img className='ml-4 opacity-50 hover:opacity-100' src={game_side_4} alt="games" width={35} />
        </div>
        
        <div className='w-full space-y-4 '>
          <img className='ml-4 opacity-50 hover:opacity-100' src={other_1} alt="games" width={35} />
          <img className=' ml-4 opacity-50 hover:opacity-100' src={other_2} alt="games" width={35} />
          <img className='ml-4 opacity-50 hover:opacity-100' src={other_3} alt="games" width={35} />
        </div>
      </div>
