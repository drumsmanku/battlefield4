...
function SideMenu() {
  return (
    <div style={{borderRight:'0.5px solid #D9D9D9'}} className=' w-[4.5%] h-full flex flex-col border-r-[#D9D9D9] justify-around'>
      <div className=' space-y-4 h-[50%]'>
        <img src={games_img} alt="games" width={50} />
        <img className='ml-4' src={other_img} alt="other" width={40} />
      </div>
