        ...
        >
          <div className="expanded-content flex flex-col items-end ">
            <div style={{ borderTop: '1px solid rgba(255, 255, 255, 0.50)' }} className='w-[90%] mt-3 text-white'>
              ...
              <div className='w-full flex items-center mt-2 space-x-2 hover:bg-white hover:text-black'>
                <div style={{backgroundColor:'rgba(255, 255, 255, 0.30)'}} className='px-2.5 py-0.5  text-slate-900 text-2xl hover:bg-black'>
                  +
                </div>
